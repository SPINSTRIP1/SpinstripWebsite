...
export default function WhoWeAre() {
  return (
    <section
      ...
      id="about-us"
      className="w-full group bg-size-[360%] lg:bg-size-[200%] rounded-4xl lg:max-w-340 lg:mx-auto relative overflow-hidden mb-20 shadow lg:flex justify-end p-5 md:p-10 items-end"
    >
