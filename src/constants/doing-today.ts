import { Card } from "@/components/doing-today";

export const EVERYONE_CARDS: Card[] = [
  {
    id: 1,
    title: "Exclusive discount/ Flash sales",
    description: `
    Unlock limited-time deals and special offers you won't find elsewhere. Discover
     curated discounts on restaurants, events, wellness spots, and more right when you need them.
    `,
    image: "/58.png",
  ...
  },
  {
    ...
    description: `
    From hidden brunch spots to weekend getaways and trusted service providers, explore what your city has to offer in one seamless space. Find trending hangouts, 
    verified vendors and curated experiences tailored to your location and lifestyle.
    `,
    image: "/79.png",
  ...
  {
    id: 5,
    title: "Saved/bookmarked collections",
    description: `
    See something you love? Save places, events and products into 
    personalised collections. Build your own list of future experiences and revisit them anytime
    `,
    image: "/79.png",
    bgColor: "bg-foreground",
    glassStyle: "card-glass",
  ...
  },
  {
    ...
    description: `
    From bookings to product purchases, enjoy smooth and secure 
    transactions directly within the app. No switching platforms, no complicated steps.
    `,
    image: "/76.png",
    bgColor: "bg-[#9E76F8]",
    glassStyle: "card-glass-purple",
  ...
  {
    id: 7,
    title: "Instant booking/reservations",
    description: `
...
or schedule services instantly without leaving the platform.
  ...
  },
  {
    ...
    description: `
 Your moment deserves more than disappearing stories. 
 Share experiences with friends inside Spinstrip or across your favourite social platforms and let your lifestyle inspire others.`,
...
export const CREATORS_CARDS: Card[] = [
  ...
  //   },
  {
    ...
    description: `
Partner directly with businesses and participate in curated campaigns. Spinstrip connects your content to real venues, products and experiences.
    `,
    image: "/29.png",
    bgColor: "bg-[#9E76F8]",
    glassStyle: "card-glass-purple",
  ...
  {
    id: 6,
    title: "Affiliate & Commission opportunities",
    description: `
...
export const BUSINESS_CARDS: Card[] = [
  ...
  {
    id: 3,
    title: "Event Creation & Ticket Sales",
    description: `
  ...
  {
    id: 7,
    title: "Create Reservations & Bookings",
    description: `
